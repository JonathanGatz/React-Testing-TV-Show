...
const episodesData= [ // Test the actual coded data 
    {
        id: 553946,
...
test("Hopefully shows the list of episodes", () => {
    const { rerender, queryAllByText, getAllByText } = render( // calling query alot for this type of testing..
        <Episodes episodes={[]}/>
    )
    ...
    // Testing is actually pretty neat. My favorite by far is thee live feed on Cypris.io  